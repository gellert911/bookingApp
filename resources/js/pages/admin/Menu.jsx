...
function Menu ({selectedMenu, setSelectedMenu}) {
    const menus = ["Overview", "Settings", "Services", "Opening hours", "Appointments", "Audit logs"]
    const icons = ["fa-bars-progress", "fa-gear", "fa-layer-group", "fa-clock", "fa-calendar-days", "fa-book-open"]
